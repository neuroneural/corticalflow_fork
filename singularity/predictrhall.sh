...
white_model.model_checkpoint=/corticalflow/resources/trained_models/CFPP_RIGHT_WHITE.pth \
...
pial_model.model_checkpoint=/corticalflow/resources/trained_models/CFPP_RIGHT_PIAL.pth \
outputs.output_dir=/data/users2/washbee/corticalflow/output_dir_rh/predict_debug/ \
